...
Run a tiny CUDA language-model head before and after INT4 weight Q/DQ, then compare cross-entropy, perplexity, top-1 agreement, and slice metrics.
...
- **Recorded outcome:** Multiple frozen metrics exposed the synthetic INT4 regression; they are not scores for a named language model.
