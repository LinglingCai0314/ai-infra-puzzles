...
# Lesson 16 — Tensor Cores and Dtype Semantics
...
[← Chapter 05](../README.md) · [中文本课](../../../chapters-zh/05-triton-gpu-programming/16-tensor-cores-dtypes/README.md) · [Executed notebook](lab.ipynb) · [RTX 5090 result](artifacts/rtx5090-result.json)

## Why this puzzle matters

This lesson isolates **input dtype, accumulator precision, throughput, and error**. The goal is
...
tl.dot can lower to target matrix instructions when dtype, shape, and backend permit it. Input
storage, multiply precision, accumulator type, and output cast are separate choices. A
throughput table is incomplete without error measured against a declared reference.
...
Combining FP16, BF16, TF32, and FP8 under one 'Tensor Core' row compares different numerical
contracts.
...
BF16 Triton and library GEMM are reported separately: 0.0251 and 0.0155 ms, with FP32-comparison
max error 0.000e+00.
...
architecture, concurrency, or surrounding graph differs. Combining FP16, BF16, TF32, and FP8
under one 'Tensor Core' row compares different numerical contracts. Reopen the decision when any
of those conditions changes or when a profiler contradicts the proposed mechanism.
