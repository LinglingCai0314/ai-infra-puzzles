...
# Lesson 19 — Numerical Stability and Cast Boundaries
...
[← Chapter 05](../README.md) · [中文本课](../../../chapters-zh/05-triton-gpu-programming/19-numerical-stability/README.md) · [Executed notebook](lab.ipynb) · [RTX 5090 result](artifacts/rtx5090-result.json)

## Why this puzzle matters

This lesson isolates **max shifting, FP32 accumulation, overflow, and underflow**. The goal is
...
Low-precision storage does not require low-precision reduction. Stable Softmax subtracts the row
maximum before exp and normally accumulates the denominator in FP32. Each cast boundary is
therefore an algorithm choice, not formatting.
...
Small random inputs may never exercise overflow, underflow, cancellation, or long-reduction
error.
...
The unshifted FP16 expression produced 2,096,519 non-finite values. Max-shifted Triton softmax
produced none and differed from FP32 reference by 2.439e-04.
...
architecture, concurrency, or surrounding graph differs. Small random inputs may never exercise
overflow, underflow, cancellation, or long-reduction error. Reopen the decision when any of
those conditions changes or when a profiler contradicts the proposed mechanism.
