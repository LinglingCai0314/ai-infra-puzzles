...
# AI Infra Puzzles 中文章节

[中文首页](../README_ZH.md) · [English README](../README.md)

这里是中文教程的章节入口。中文文档忠实对应英文版的结构与内容；代码、命令、公式、证据标签和实测数字保持不变。Notebook 与 RTX 5090 JSON 仍以英文目录中的文件为唯一可信来源，不在中文目录中复制实验输出。
...
| 第 05 章 — Triton GPU 编程与 CUDA 性能对比 | 30 | [进入章节](05-triton-gpu-programming/README.md) |
